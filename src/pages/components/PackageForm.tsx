...
export const PackageForm = ({ pkg, onChange, onRemove, isNew = false }: PackageFormProps) => {
   return (
      <Form layout="vertical" className={`${styles.packageContainer} ${isNew ? styles.newPackage : styles.addedPackage}`} 
         ...
         >
            ...
            <div className={styles.buttonContainer}>
               {isNew ? (
                  <Button className={styles.addPackageButton} type="default" onClick={onRemove}>Agregar <PlusOutlined /></Button>
               ) : (
